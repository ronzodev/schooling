...
//   final GoogleAdsController _adsController = GoogleAdsController.instance; // Add ads controller

//   @override
//   void initState() {
//     super.initState();
//     // Initialize ads controller and load banner ad
//     _initializeBannerAd();
//   }

//   @override
//   void dispose() {
//     // Clean up banner ad when leaving screen
//     _adsController.disposeBannerAd();
//     super.dispose();
//   }
...
//     if (!_adsController.isBannerReady()) {
//       await _adsController.loadBannerAd();
//     }
//   }
...
//         children: [
//           // Banner Ad Section
//           _buildBannerAdSection(isDarkMode),
...
//   Widget _buildBannerAdSection(bool isDarkMode) {
//     final bannerAdWidget = _adsController.getBannerAdWidget();
    
//     if (bannerAdWidget == null) {
//       // Return empty space if ad isn't ready - no loading indicators
